...
define config.name = _("Spellbound")
...
define gui.about = _p("""
A game by {b}WhytShadow{/b}
\n
\n{u}Credits{/u}:
\nSprites by {i}RedChan/WithoutPenorPaper{/i}
\n Backgrounds from {a=https://www7b.biglobe.ne.jp}www7b.biglobe.ne.jp{/a} and {a=https://www.rawpixel.com}www.rawpixel.com{/a}
\nTitle Font {b}Wizard's Magic{/b} by {i}SpideRaYsfoNtS{/i}
\n
""")
...
define config.save_directory = "Spellbound-1567601874"
